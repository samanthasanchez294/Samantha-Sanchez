...
def main():
    ...
    with consent:
        ...
        - I am aware that my data will be collected solely for research ad improvement purposes.
        - I can withdraw at any time.
        """)

        consent_given = st.checkbox("I agree to the terms above.")

        # End of my TODO section
        # --------------------------------------------------------------------------------------------------------#
    ...
    with tasks:
        ...
        if start_button:
            ...
            st.success("Task timer started. Complete your task and then click 'Stop Task Timer'")
    ...
    with exit:
        ...
        with st.form("exit_form"):
            ...
            difficulty = st.slider("Overall Difficulty(1 = Very Easy, 5 = Very Hard)", min_value=1, max_value=5, value=3)
